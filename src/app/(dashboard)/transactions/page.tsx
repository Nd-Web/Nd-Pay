    ...
    >
      ...
      >
        ...
        <div className="relative shrink-0">
          ...
          <div className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-[#0f0a1e] flex items-center justify-center ${isSent ? 'bg-white/20' : 'bg-emerald-500'}`}>
            {isSent
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="text-right">
            <p className={`text-sm font-bold ${isSent ? 'text-white' : 'text-emerald-400'}`}>
  ...
  return (
    <div className="min-h-screen">
      ...
      {!isLoading && allTxns.length > 0 && (
        ...
        >
          <div className="rounded-2xl bg-red-500/10 border border-red-500/15 p-4">
            <div className="flex items-center gap-1.5 mb-1">
              <ArrowUpRight className="w-3.5 h-3.5 text-red-400" />
              <span className="text-red-400 text-[10px] font-semibold uppercase tracking-wide">Sent</span>
            </div>
            <p className="text-white font-bold text-lg">{formatCurrency(totalSent, 'USD', true)}</p>
          </div>
          <div className="rounded-2xl bg-emerald-500/10 border border-emerald-500/15 p-4">
            <div className="flex items-center gap-1.5 mb-1">
              <ArrowDownLeft className="w-3.5 h-3.5 text-emerald-400" />
              <span className="text-emerald-400 text-[10px] font-semibold uppercase tracking-wide">Received</span>
            </div>
            <p className="text-white font-bold text-lg">{formatCurrency(totalReceived, 'USD', true)}</p>
          </div>
        </motion.div>
      )}
